          ...
          categories.map(c => {
              ...
              return (
                <div
                  ...
                  className={`md:ml-4 w-full md:w-auto text-center text-xs font-bold leading-sm uppercase px-3 md:px-3 py-2 md:py-1 rounded-full border cursor-pointer ${isActive ? "bg-green-200 text-accent-default" : "bg-white text-font-light"} `}
                >
                  {c.name}
                </div>
              )
